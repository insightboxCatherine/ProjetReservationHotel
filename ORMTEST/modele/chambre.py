...
class TypeChambre(Base):
    ...
    PKTYP_id: Mapped[str] = mapped_column(primary_key=True)
...
class Client(Base):
    ...
    PKCLI_id: Mapped[str] = mapped_column(primary_key=True)
...
class Reservation(Base):
    ...
    PKRES_id: Mapped[str] = mapped_column(primary_key=True)
